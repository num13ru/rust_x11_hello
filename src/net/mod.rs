...
/// Default PaperSpoon address: the legacy USBNetwork static host. This
/// device (a Paperwhite 6) cannot run USBNetwork — no maintained package
/// accepts it (see `docs/usbnetwork-pw2-report.md`) — so runs set
